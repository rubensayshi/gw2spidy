...
abstract class BaseWorkerQueueItem extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the worker field.
     * Note: this column has a database default value of: ''
     * @var        string
     */
    protected $worker;
    ...
    /**
     * The value for the max_timeout field.
     * Note: this column has a database default value of: 3600
     * @var        int
     */
    ...
    /**
     * Get the [max_timeout] column value.
     * 
     * @return   int
     */
