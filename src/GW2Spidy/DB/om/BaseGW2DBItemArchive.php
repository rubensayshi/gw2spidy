...
/**
 * Base class that represents a row from the 'gw2db_item_archive' table.
 *
 * 
 *
 * @package    propel.generator.gw2spidy.om
 */
abstract class BaseGW2DBItemArchive extends BaseObject implements Persistent
{

    /**
     * Peer class name
     */
    const PEER = 'GW2Spidy\\DB\\GW2DBItemArchivePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        GW2DBItemArchivePeer
     */
    ...
    /**
     * The value for the dataid field.
     * @var        int
     */
    protected $dataid;
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = GW2DBItemArchivePeer::ID;
        }
    ...
    public function setExternalid($v)
    {
        ...
        if ($this->externalid !== $v) {
            $this->externalid = $v;
            $this->modifiedColumns[] = GW2DBItemArchivePeer::EXTERNALID;
        }
    ...
    /**
     * Set the value of [dataid] column.
     * 
     * @param      int $v new value
     * @return   GW2DBItemArchive The current object (for fluent API support)
     */
    public function setDataid($v)
    {
        ...
        if ($this->dataid !== $v) {
            $this->dataid = $v;
            $this->modifiedColumns[] = GW2DBItemArchivePeer::DATAID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = GW2DBItemArchivePeer::NAME;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = GW2DBItemArchivePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = GW2DBItemArchiveQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GW2DBItemArchivePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GW2DBItemArchivePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(GW2DBItemArchivePeer::EXTERNALID)) {
            $modifiedColumns[':p' . $index++]  = '`EXTERNALID`';
        }
        if ($this->isColumnModified(GW2DBItemArchivePeer::DATAID)) {
            $modifiedColumns[':p' . $index++]  = '`DATAID`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`EXTERNALID`':
                        ...
                        break;
                    case '`DATAID`':
						$stmt->bindValue($identifier, $this->dataid, PDO::PARAM_INT);
                        break;
                    case '`NAME`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = GW2DBItemArchivePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = GW2DBItemArchivePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['GW2DBItemArchive'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['GW2DBItemArchive'][$this->getPrimaryKey()] = true;
        $keys = GW2DBItemArchivePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GW2DBItemArchivePeer::ID)) $criteria->add(GW2DBItemArchivePeer::ID, $this->id);
    ...
    {
        $criteria = new Criteria(GW2DBItemArchivePeer::DATABASE_NAME);
        $criteria->add(GW2DBItemArchivePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of GW2DBItemArchive (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 GW2DBItemArchive Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return   GW2DBItemArchivePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new GW2DBItemArchivePeer();
        }
    ...
    {
        return (string) $this->exportTo(GW2DBItemArchivePeer::DEFAULT_STRING_FORMAT);
    }
