...
/**
 * Base class that represents a row from the 'watchlist' table.
 *
 * 
 *
 * @package    propel.generator.gw2spidy.om
 */
abstract class BaseWatchlist extends BaseObject implements Persistent
{

    /**
     * Peer class name
     */
    const PEER = 'GW2Spidy\\DB\\WatchlistPeer';
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = WatchlistPeer::ID;
        }
    ...
    public function setItemId($v)
    {
        ...
        if ($this->item_id !== $v) {
            $this->item_id = $v;
            $this->modifiedColumns[] = WatchlistPeer::ITEM_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = WatchlistPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Watchlist object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = WatchlistPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = WatchlistQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                WatchlistPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(WatchlistPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(WatchlistPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`USER_ID`';
        }
        if ($this->isColumnModified(WatchlistPeer::ITEM_ID)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = WatchlistPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = WatchlistPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Watchlist'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Watchlist'][$this->getPrimaryKey()] = true;
        $keys = WatchlistPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(WatchlistPeer::ID)) $criteria->add(WatchlistPeer::ID, $this->id);
        if ($this->isColumnModified(WatchlistPeer::USER_ID)) $criteria->add(WatchlistPeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(WatchlistPeer::ITEM_ID)) $criteria->add(WatchlistPeer::ITEM_ID, $this->item_id);
    ...
    {
        $criteria = new Criteria(WatchlistPeer::DATABASE_NAME);
        $criteria->add(WatchlistPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of Watchlist (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 Watchlist Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return   WatchlistPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new WatchlistPeer();
        }
    ...
    {
        return (string) $this->exportTo(WatchlistPeer::DEFAULT_STRING_FORMAT);
    }
