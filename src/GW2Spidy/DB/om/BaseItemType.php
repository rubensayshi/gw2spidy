...
abstract class BaseItemType extends BaseObject implements Persistent
{
     ...
     * Otherwise if this ItemType is new, it will return
     * an empty collection; or if this ItemType has previously
     * been saved, it will retrieve related Items from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in ItemType.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Item[] List of Item objects
     */
    public function getItemsJoinItemSubType($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ItemQuery::create(null, $criteria);
        $query->joinWith('ItemSubType', $join_behavior);
