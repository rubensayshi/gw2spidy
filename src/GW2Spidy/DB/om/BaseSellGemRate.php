...
/**
 * Base class that represents a row from the 'sell_gem_rate' table.
 *
 * 
 *
 * @package    propel.generator.gw2spidy.om
 */
abstract class BaseSellGemRate extends BaseObject implements Persistent
{

    /**
     * Peer class name
     */
    const PEER = 'GW2Spidy\\DB\\SellGemRatePeer';
     ...
     * @return   SellGemRate The current object (for fluent API support)
     */
    public function setRateDatetime($v)
    {
        ...
        if ($this->rate_datetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SellGemRatePeer::RATE_DATETIME;
            }
    ...
    public function setAverage($v)
    {
        ...
        if ($this->average !== $v) {
            $this->average = $v;
            $this->modifiedColumns[] = SellGemRatePeer::AVERAGE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = SellGemRatePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating SellGemRate object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = SellGemRatePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = SellGemRateQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SellGemRatePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SellGemRatePeer::RATE_DATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`RATE_DATETIME`';
        }
        if ($this->isColumnModified(SellGemRatePeer::AVERAGE)) {
            $modifiedColumns[':p' . $index++]  = '`AVERAGE`';
        }

        $sql = sprintf(
            'INSERT INTO `sell_gem_rate` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = SellGemRatePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = SellGemRatePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['SellGemRate'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SellGemRate'][$this->getPrimaryKey()] = true;
        $keys = SellGemRatePeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SellGemRatePeer::RATE_DATETIME)) $criteria->add(SellGemRatePeer::RATE_DATETIME, $this->rate_datetime);
        if ($this->isColumnModified(SellGemRatePeer::AVERAGE)) $criteria->add(SellGemRatePeer::AVERAGE, $this->average);
    ...
    {
        $criteria = new Criteria(SellGemRatePeer::DATABASE_NAME);
        $criteria->add(SellGemRatePeer::RATE_DATETIME, $this->rate_datetime);
     ...
     * objects.
     *
     * @param      object $copyObj An object of SellGemRate (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 SellGemRate Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return   SellGemRatePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new SellGemRatePeer();
        }
    ...
    {
        return (string) $this->exportTo(SellGemRatePeer::DEFAULT_STRING_FORMAT);
    }
