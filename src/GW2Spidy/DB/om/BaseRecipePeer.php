...
abstract class BaseRecipePeer {
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('DataId', 'Name', 'DisciplineId', 'Rating', 'ResultItemId', 'Count', 'Gw2dbId', 'Gw2dbExternalId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('dataId', 'name', 'disciplineId', 'rating', 'resultItemId', 'count', 'gw2dbId', 'gw2dbExternalId', ),
        BasePeer::TYPE_COLNAME => array (RecipePeer::DATA_ID, RecipePeer::NAME, RecipePeer::DISCIPLINE_ID, RecipePeer::RATING, RecipePeer::RESULT_ITEM_ID, RecipePeer::COUNT, RecipePeer::GW2DB_ID, RecipePeer::GW2DB_EXTERNAL_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('DATA_ID', 'NAME', 'DISCIPLINE_ID', 'RATING', 'RESULT_ITEM_ID', 'COUNT', 'GW2DB_ID', 'GW2DB_EXTERNAL_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('data_id', 'name', 'discipline_id', 'rating', 'result_item_id', 'count', 'gw2db_id', 'gw2db_external_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('DataId' => 0, 'Name' => 1, 'DisciplineId' => 2, 'Rating' => 3, 'ResultItemId' => 4, 'Count' => 5, 'Gw2dbId' => 6, 'Gw2dbExternalId' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('dataId' => 0, 'name' => 1, 'disciplineId' => 2, 'rating' => 3, 'resultItemId' => 4, 'count' => 5, 'gw2dbId' => 6, 'gw2dbExternalId' => 7, ),
        BasePeer::TYPE_COLNAME => array (RecipePeer::DATA_ID => 0, RecipePeer::NAME => 1, RecipePeer::DISCIPLINE_ID => 2, RecipePeer::RATING => 3, RecipePeer::RESULT_ITEM_ID => 4, RecipePeer::COUNT => 5, RecipePeer::GW2DB_ID => 6, RecipePeer::GW2DB_EXTERNAL_ID => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('DATA_ID' => 0, 'NAME' => 1, 'DISCIPLINE_ID' => 2, 'RATING' => 3, 'RESULT_ITEM_ID' => 4, 'COUNT' => 5, 'GW2DB_ID' => 6, 'GW2DB_EXTERNAL_ID' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('data_id' => 0, 'name' => 1, 'discipline_id' => 2, 'rating' => 3, 'result_item_id' => 4, 'count' => 5, 'gw2db_id' => 6, 'gw2db_external_id' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
