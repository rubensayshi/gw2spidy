 ...
 */
abstract class BaseRecipeIngredient extends BaseObject implements Persistent
{

    /**
     * Peer class name
     */
    const PEER = 'GW2Spidy\\DB\\RecipeIngredientPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        RecipeIngredientPeer
     */
    ...
    /**
     * The value for the recipe_id field.
     * @var        int
     */
    protected $recipe_id;
    ...
    /**
     * Initializes internal state of BaseRecipeIngredient object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [recipe_id] column value.
     * 
     * @return   int
     */
    ...
    public function setRecipeId($v)
    {
        ...
        if ($this->recipe_id !== $v) {
            $this->recipe_id = $v;
            $this->modifiedColumns[] = RecipeIngredientPeer::RECIPE_ID;
        }

        if ($this->aRecipe !== null && $this->aRecipe->getDataId() !== $v) {
            $this->aRecipe = null;
        }
    ...
    public function setItemId($v)
    {
        ...
        if ($this->item_id !== $v) {
            $this->item_id = $v;
            $this->modifiedColumns[] = RecipeIngredientPeer::ITEM_ID;
        }
    ...
    public function setCount($v)
    {
        ...
        if ($this->count !== $v) {
            $this->count = $v;
            $this->modifiedColumns[] = RecipeIngredientPeer::COUNT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->recipe_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->item_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->count = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = RecipeIngredientPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating RecipeIngredient object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aRecipe !== null && $this->recipe_id !== $this->aRecipe->getDataId()) {
            $this->aRecipe = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RecipeIngredientPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RecipeIngredientQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RecipeIngredientPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aRecipe !== null) {
                if ($this->aRecipe->isModified() || $this->aRecipe->isNew()) {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RecipeIngredientPeer::RECIPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`RECIPE_ID`';
        }
        if ($this->isColumnModified(RecipeIngredientPeer::ITEM_ID)) {
            $modifiedColumns[':p' . $index++]  = '`ITEM_ID`';
        }
        if ($this->isColumnModified(RecipeIngredientPeer::COUNT)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RecipeIngredientPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RecipeIngredientPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['RecipeIngredient'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['RecipeIngredient'][serialize($this->getPrimaryKey())] = true;
        $keys = RecipeIngredientPeer::getFieldNames($keyType);
        $result = array(
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aRecipe) {
                $result['Recipe'] = $this->aRecipe->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
            if (null !== $this->aItem) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setCount($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RecipeIngredientPeer::RECIPE_ID)) $criteria->add(RecipeIngredientPeer::RECIPE_ID, $this->recipe_id);
        if ($this->isColumnModified(RecipeIngredientPeer::ITEM_ID)) $criteria->add(RecipeIngredientPeer::ITEM_ID, $this->item_id);
        if ($this->isColumnModified(RecipeIngredientPeer::COUNT)) $criteria->add(RecipeIngredientPeer::COUNT, $this->count);
    ...
    {
        $criteria = new Criteria(RecipeIngredientPeer::DATABASE_NAME);
        $criteria->add(RecipeIngredientPeer::RECIPE_ID, $this->recipe_id);
        $criteria->add(RecipeIngredientPeer::ITEM_ID, $this->item_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getRecipeId()) && (null === $this->getItemId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of RecipeIngredient (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 RecipeIngredient Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return   RecipeIngredientPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new RecipeIngredientPeer();
        }
    ...
    public function getItem(PropelPDO $con = null)
    {
        if ($this->aItem === null && ($this->item_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aItem->addIngredients($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(RecipeIngredientPeer::DEFAULT_STRING_FORMAT);
    }
